    ...
    >
      <div className='relative w-full'>
        <div className='flex justify-end gap-2 mr-10'>
          <button
            className='relative z-40 h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center disabled:opacity-50'
            onClick={scrollLeft}
            ...
            >
              ...
              <div className='flex justify-center h-full'>
                <BlurImage
                  ...
                  width={100}
                  height={400}
                  className='object-contain z-10 inset-0 !w-[80%] !h-[80%]'
                />
              </div>
            </motion.div>
          </div>
